...
5. [ox_doorlock](https://github.com/overextended/ox_doorlock) Latest version with Qbcore support you may also need to add some exports from the new versions or [qb-doorlock](https://github.com/qbcore-framework/qb-doorlock)
