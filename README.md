...
3. [ox_lib]([https://github.com/overextended/ox_lib](https://github.com/overextended/ox_lib/releases)) - Use the latest release. If you do not use the latest release, MAKE SURE TO BUILD THE UI. Find their docs [here](https://overextended.dev/ox_lib#building-the-ui) on how to build the UI.
